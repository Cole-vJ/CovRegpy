...
# index_returns.to_csv('../FTSE100_Data/ftse_indices.csv')

index_returns = pd.read_csv('../FTSE100_Data/ftse_indices.csv', header=0)
...
returns_high_storage.to_csv('../FTSE100_Data/ftse_indices_high_freq_weights.csv')
returns_mid_storage.to_csv('../FTSE100_Data/ftse_indices_mid_freq_weights.csv')
returns_low_storage.to_csv('../FTSE100_Data/ftse_indices_low_freq_weights.csv')
returns_gdp_storage.to_csv('../FTSE100_Data/ftse_indices_gdp_freq_weights.csv')
