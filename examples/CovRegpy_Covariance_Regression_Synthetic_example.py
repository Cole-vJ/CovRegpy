...
# example provides empirical evidence of isolating 'correct' coefficients driving underlying covariance.
...
# from CovRegpyCovRegpy import cov_reg_given_mean
...
# plot of synthetic underlying structures that will drive synthetic asset correlation structures
plt.title('Synthetic Covariates')
